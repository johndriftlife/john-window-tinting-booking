...
export default function Home(){
  ...
  const [pricing, setPricing] = useState({ pricing:{}, percent:20, currency:'eur' })
  ...
  const liveTotals = useMemo(()=>{
    ...
    const deposit = Math.round(total * (Number(pricing.percent||20)/100))
        ...
        {serviceId && (
          <fieldset>
            ...
            <div className="priceRow">
              ...
              <span className="badge">Deposit (20%): {fmt(liveTotals.deposit, liveTotals.currency)}</span>
            </div>
          </fieldset>
        )}
